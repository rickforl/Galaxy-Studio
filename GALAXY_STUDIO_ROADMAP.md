...
- Coming: a galaxy **coordinate / grid system** — the fade/nebula/image **Map** track anchors to `gen.radius` as a stand-in; swap for a real coordinate boundary or grid ring when it lands (every Map-track setting carries over).
